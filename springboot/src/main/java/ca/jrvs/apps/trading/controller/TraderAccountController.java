...
public class TraderAccountController {
    ...
    notes = "TraderId and AccountId are auto generated by the databse, "
    + "and they should be identical. Assume each trader has one exact account")
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 404, message = "traderId is not found"),
            @ApiResponse(code = 400, message = "Unable to withdraw due to user input. (e.g. insufficient balance)")})
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
